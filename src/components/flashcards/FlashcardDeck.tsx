...
export function FlashcardDeck({
    ...
    return (
      <div className="text-center py-20">
        ...
        <div className="flex flex-col gap-4 items-center">
          <button
            onClick={() => router.push("/")}
            className="px-6 py-2 bg-blue-600 hover:bg-blue-500 rounded-lg text-white transition"
          >
            Go Home
          </button>
          ...
          >
            {isBackfilling
              ? "Analyzing..."
              : "Analyze past quiz mistakes for new cards"}
          </button>
        </div>
      </div>
    );
    ...
    return (
      <div className="text-center py-20 animate-in fade-in zoom-in duration-500">
        ...
        <p className="text-gray-400 mb-8">
          You've reviewed {cards.length} cards today.
        </p>
        <div className="flex gap-4 justify-center">
          ...
          <button
            ...
            className="px-6 py-3 bg-blue-600 hover:bg-blue-500 rounded-lg text-white transition flex items-center"
          >
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8">
      ...
      <div
        className={`transition-all duration-500 transform ${isFlipped ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4 pointer-events-none"}`}
      >
